...
for j = 1:length(Perms)
    ...
    fprintf(fid, ' r%d: 2 x%d + x%d + x%d + x%d - 2 x%d - x%d - x%d  <= 3\n',r,setind(2^(Sj(1)-1) + 2^(Sj(2)-1) ), setind(2^(Sj(1)-1) + 2^(Sj(3)-1) ),setind(2^(Sj(2)-1) + 2^(Sj(3)-1) ),setind(2^(Sj(3)-1) + 2^(Sj(4)-1) ) , setind(2^(Sj(1)-1) + 2^(Sj(2)-1)+2^(Sj(3)-1) ), setind(2^(Sj(1)-1) + 2^(Sj(3)-1)+2^(Sj(4)-1) ), setind(2^(Sj(2)-1) + 2^(Sj(3)-1)+2^(Sj(4)-1) ));   
    r=r+1;    
